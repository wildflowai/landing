...
const Steps = () => {
  ...
  return (
    <section className="mx-auto flex min-h-screen w-full items-center justify-center bg-primary-50 px-4 py-16 dark:bg-slate-800 sm:px-6 lg:px-8 lg:py-20">
      <div className="max-w-3xl">
        <div className="row-gap-10 /*md:grid-cols-2*/ grid gap-6">
