...
import wildflowWideImg from "~/assets/images/whale.jpg";
import wildflowImg from "~/assets/images/whale.png";
...
export const heroData: HeroProps = {
  title: <>Ocean biodiversity data platform</>,
  subtitle: (
    <>
      Harness the potential of biodiversity data to drive <a>nature‑first</a>{" "}
      workflows, <a>AI‑powered</a> insights and global broadcasting.
    </>
  ),
  callToAction: {
    text: "Try our prototype",
...
//     title: (
//       <>
//         What you get with <span className="whitespace-nowrap">wildflow</span>
//       </>
//     ),
//     subtitle:
...
export const stepsData: StepsProps = {
  title: "Empower biodiversity researchers with modern AI infrastructure!",
  items: [
    {
    ...
    {
      title: "Accelerate biodiversity research and conservation!",
      icon: IconCheck,
    },
  ],
  image: {
